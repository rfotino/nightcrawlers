...
export class Game {
  ...
  public constructor() {
    ...
    PIXI.loader
      ...
      .add('game/day/gravestone1', 'assets/images/game/gravestone1.png')
      .add('game/day/gravestone2', 'assets/images/game/gravestone2.png')
      .add('game/day/tree1', 'assets/images/game/tree1-day.png')
      .add('game/day/tree2', 'assets/images/game/tree2.png')
      .add('game/night/gravestone1', 'assets/images/game/gravestone1.png')
      .add('game/night/gravestone2', 'assets/images/game/gravestone2.png')
      .add('game/night/tree1', 'assets/images/game/tree1-night.png')
      .add('game/night/tree2', 'assets/images/game/tree2.png')
